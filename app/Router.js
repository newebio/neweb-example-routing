...
class Router extends neweb_1.ClassicRouter {
    onInit() {
        ...
        this.addRoute(neweb_1.MatchedRoute({ path: "/" }, neweb_1.PageRouteWithParent(parentMiddleware, neweb_1.PageRouteByFrame({ frameName: "index" }))));
        this.addRoute(neweb_1.MatchedRoute({ path: "/page2" }, neweb_1.PageRouteWithParent(parentMiddleware, neweb_1.PageRouteByFrame({ frameName: "page2" }))));
